...
func RegisterZoneHTTPServer(s *http.Server, srv ZoneHTTPServer) {
	r := s.Route("/")
	r.GET("/api/console/zone", _Zone_List0_HTTP_Handler(srv))
	r.GET("/api/console/zone/simple", _Zone_SimpleList0_HTTP_Handler(srv))
	r.GET("/api/console/zone/{id}", _Zone_Get0_HTTP_Handler(srv))
	r.POST("/api/console/zone", _Zone_Create0_HTTP_Handler(srv))
	r.PUT("/api/console/zone/{id}", _Zone_Update0_HTTP_Handler(srv))
	r.POST("/api/console/zone/{id}/disable", _Zone_Disable0_HTTP_Handler(srv))
	r.DELETE("/api/console/zone/{id}", _Zone_Delete0_HTTP_Handler(srv))
}

func _Zone_List0_HTTP_Handler(srv ZoneHTTPServer) func(ctx http.Context) error {
...
func _Zone_SimpleList0_HTTP_Handler(srv ZoneHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Zone_Get0_HTTP_Handler(srv ZoneHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Zone_Create0_HTTP_Handler(srv ZoneHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Zone_Update0_HTTP_Handler(srv ZoneHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Zone_Delete0_HTTP_Handler(srv ZoneHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
