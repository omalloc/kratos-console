...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	r := s.Route("/")
	r.GET("/api/console/app", _App_List1_HTTP_Handler(srv))
	r.GET("/api/console/app/{id}", _App_Get1_HTTP_Handler(srv))
	r.POST("/api/console/app", _App_Create1_HTTP_Handler(srv))
	r.PUT("/api/console/app/{id}", _App_Update1_HTTP_Handler(srv))
	r.DELETE("/api/console/app/{id}", _App_Delete1_HTTP_Handler(srv))
}

func _App_List1_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
...
func _App_Get1_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _App_Create1_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _App_Update1_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _App_Delete1_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
