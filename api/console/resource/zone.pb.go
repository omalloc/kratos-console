...
func file_console_resource_zone_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_console_resource_zone_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_console_resource_zone_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_console_resource_zone_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SimpleListReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
