...
func RegisterNamespaceHTTPServer(s *http.Server, srv NamespaceHTTPServer) {
	r := s.Route("/")
	r.GET("/api/console/namespace", _Namespace_List0_HTTP_Handler(srv))
	r.GET("/api/console/namespace/-/options", _Namespace_SimpleList0_HTTP_Handler(srv))
	r.GET("/api/console/namespace/{id}", _Namespace_Get0_HTTP_Handler(srv))
	r.POST("/api/console/namespace", _Namespace_Create0_HTTP_Handler(srv))
	r.PUT("/api/console/namespace/{id}", _Namespace_Update0_HTTP_Handler(srv))
	r.DELETE("/api/console/namespace/{id}", _Namespace_Delete0_HTTP_Handler(srv))
}

func _Namespace_List0_HTTP_Handler(srv NamespaceHTTPServer) func(ctx http.Context) error {
...
func _Namespace_SimpleList0_HTTP_Handler(srv NamespaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Namespace_Get0_HTTP_Handler(srv NamespaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Namespace_Create0_HTTP_Handler(srv NamespaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Namespace_Update0_HTTP_Handler(srv NamespaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Namespace_Delete0_HTTP_Handler(srv NamespaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
