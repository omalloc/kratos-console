...
func (c *zoneClient) List(ctx context.Context, in *GetZoneListRequest, opts ...grpc.CallOption) (*GetZoneListReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneClient) SimpleList(ctx context.Context, in *SimpleListRequest, opts ...grpc.CallOption) (*SimpleListReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_SimpleList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneClient) Get(ctx context.Context, in *GetZoneRequest, opts ...grpc.CallOption) (*GetZoneReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneClient) Create(ctx context.Context, in *CreateZoneRequest, opts ...grpc.CallOption) (*CreateZoneReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneClient) Update(ctx context.Context, in *UpdateZoneRequest, opts ...grpc.CallOption) (*UpdateZoneReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneClient) Disable(ctx context.Context, in *DisableZoneRequest, opts ...grpc.CallOption) (*DisableZoneReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_Disable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneClient) Delete(ctx context.Context, in *DeleteZoneRequest, opts ...grpc.CallOption) (*DeleteZoneReply, error) {
	...
	err := c.cc.Invoke(ctx, Zone_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedZoneServer must be embedded to have
...
func (UnimplementedZoneServer) testEmbeddedByValue()              {}
...
func RegisterZoneServer(s grpc.ServiceRegistrar, srv ZoneServer) {
	// If the following call pancis, it indicates UnimplementedZoneServer was
