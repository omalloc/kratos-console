...
func RegisterNodeHTTPServer(s *http.Server, srv NodeHTTPServer) {
	...
	r.POST("/api/console/node", _Node_Create2_HTTP_Handler(srv))
	r.PUT("/api/console/node/{id}", _Node_Update2_HTTP_Handler(srv))
}
...
func _Node_Create2_HTTP_Handler(srv NodeHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _Node_Update2_HTTP_Handler(srv NodeHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
