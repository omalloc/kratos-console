...
type App struct {
	...
	Name        string   `json:"name" gorm:"column:name;type:varchar(64);not null;uniqueIndex:uk_name_namespace;comment:应用名称"`
	...
	NamespaceID int64    `json:"namespace_id" gorm:"column:namespace_id;type:bigint(20);not null;uniqueIndex:uk_name_namespace;comment:应用所属命名空间ID"`
